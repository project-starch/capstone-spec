...
|<<load-store-cap,LDC>> |I |`0` |`011` | - | I | - | C | S | N | T
| |I |`1` |`011` | - | C | - | C | S | N | T
| |I |- |`011` | - | C | - | C | S | S | T
| |I |- |`011` | - | C | - | C | S | - | P
|<<load-store-cap,STC>> |S |`0` |`100` | - | I | C | - | S | N | T
| |S |`1` |`100` | - | C | C | - | S | N | T
| |S |- |`100` | - | C | C | - | S | S | T
| |S |- |`100` | - | C | C | - | S | - | P
|===
...
|<<domain-cross,CALL>>        |R |`001`    |`0100000` | C | - | C | - | S | T
|        |R |`001`    |`0100000` | C | - | C | - | - | P
|<<domain-cross,RETURN>>      |R |`001`    |`0100001` | C | I | - | - | S | T
|      |R |`001`    |`0100001` | C | I | - | - | - | P
|<<jmp-cap,CJALR>>         |I |`101`    |- | C | - | C | S | S | T
|         |I |`101`    |- | C | - | C | S | - | P
|<<branch-cap,CBNZ>>         |I |`110`    |- | I | - | C | S | S | T
|         |I |`110`    |- | I | - | C | S | - | P
|<<world-enter,CAPENTER>>    |R |`001`    |`0100010` | C | - | I | - | N | T
|<<world-exit,CAPEXIT>>     |R |`001`    |`0100011` | C | I | - | - | S | T
|===
...
|===
|Mnemonic |Format |`emode` |Func3  |Func7 | rs1 | rs2 | rd | imm[11:0] | World | Variant
|<<load-store,`lb`>> |I |`0` |`000` | - | I | - | I | S | N | T
| |I |`1` |`000` | - | C | - | I | S | N | T
| |I |- |`000` | - | C | - | I | S | S | T
| |I |- |`000` | - | C | - | I | S | - | P
|<<load-store,`lh`>> |I |`0` |`001` | - | I | - | I | S | N | T
| |I |`1` |`001` | - | C | - | I | S | N | T
| |I |- |`001` | - | C | - | I | S | S | T
| |I |- |`001` | - | C | - | I | S | - | P
|<<load-store,`lw`>> |I |`0` |`010` | - | I | - | I | S | N | T
| |I |`1` |`010` | - | C | - | I | S | N | T
| |I |- |`010` | - | C | - | I | S | S | T
| |I |- |`010` | - | C | - | I | S | - | P
|<<load-store,`ld`>> |I |`0` |`011` | - | I | - | I | S | N | T
| |I |`1` |`011` | - | C | - | I | S | N | T
| |I |- |`011` | - | C | - | I | S | S | T
| |I |- |`011` | - | C | - | I | S | - | P
|<<load-store,`lbu`>> |I |`0` |`100` | - | I | - | I | S | N | T
| |I |`1` |`100` | - | C | - | I | S | N | T
| |I |- |`100` | - | C | - | I | S | S | T
| |I |- |`100` | - | C | - | I | S | - | P
|<<load-store,`lhu`>> |I |`0` |`101` | - | I | - | I | S | N | T
| |I |`1` |`101` | - | C | - | I | S | N | T
| |I |- |`101` | - | C | - | I | S | S | T
| |I |- |`101` | - | C | - | I | S | - | P
|<<load-store,`lwu`>> |I |`0` |`110` | - | I | - | I | S | N | T
| |I |`1` |`110` | - | C | - | I | S | N | T
| |I |- |`110` | - | C | - | I | S | S | T
| |I |- |`110` | - | C | - | I | S | - | P
|===
...
|===
|Mnemonic |Format |`emode` |Func3  |Func7 | rs1 | rs2 | rd | imm[11:0] | World | Variant
|<<load-store,`sb`>> |S |`0` |`000` | - | I | I | - | S | N | T
| |S |`1` |`000` | - | C | I | - | S | N | T
| |S |- |`000` | - | C | I | - | S | S | T
| |S |- |`000` | - | C | I | - | S | - | P
|<<load-store,`sh`>> |S |`0` |`001` | - | I | I | - | S | N | T
| |S |`1` |`001` | - | C | I | - | S | N | T
| |S |- |`001` | - | C | I | - | S | S | T
| |S |- |`001` | - | C | I | - | S | - | P
|<<load-store,`sw`>> |S |`0` |`010` | - | I | I | - | S | N | T
| |S |`1` |`010` | - | C | I | - | S | N | T
| |S |- |`010` | - | C | I | - | S | S | T
| |S |- |`010` | - | C | I | - | S | - | P
|<<load-store,`sd`>> |S |`0` |`011` | - | I | I | - | S | N | T
| |S |`1` |`011` | - | C | I | - | S | N | T
| |S |- |`011` | - | C | I | - | S | S | T
| |S |- |`011` | - | C | I | - | S | - | P
|===
