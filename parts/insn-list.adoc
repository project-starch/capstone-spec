...
|link:#tighten[TIGHTEN]     |CI |`001`    |`0000010` | C | - | C | Z | - | * | *
|link:#delin[DELIN]       |R |`001`    |`0000011` | - | - | C | - | - | * | *
|link:#field-query[LCC]         |CI |`001`    |`0000100` | C | - | I | Z | - | * | *
...
|link:#domain-cross[CALL]        |R |`001`    |`0100000` | C | - | C | - | S | T
|        |R |`001`    |`0100000` | C | - | C | - | - | P
|link:#domain-cross[RETURN]      |R |`001`    |`0100001` | C | I | - | - | S | T
|      |R |`001`    |`0100001` | C | I | - | - | - | P
|link:#jmp-cap[CJALR]         |I |`101`    |- | C | - | C | S | S | T
|         |I |`101`    |- | C | - | C | S | - | P
|link:#branch-cap[CBNZ]         |I |`110`    |- | I | - | C | S | S | T
|         |I |`110`    |- | I | - | C | S | - | P
|link:#world-enter[CAPENTER]    |R |`001`    |`0100010` | C | - | I | - | N | T
|link:#world-exit[CAPEXIT]     |R |`001`    |`0100011` | C | I | - | - | S | T
|===
...
|===
|Mnemonic |Format |Func3  |Func7 | rs1 | rs2 | rd | imm[11:0] | World | Variant
|link:#ctrl-status[CCSRRW] |I |`111`    | - | C | - | C | Z | * | *
|===
