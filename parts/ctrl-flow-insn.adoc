...
| Sealed | `0` | No | No | No
| Sealed | `1` | No | No | No
| Sealed-return | `0` | `cursor in [base + 3 * CLENBYTES, end)` | `cursor in [base + 3 * CLENBYTES, end)` | No
| Sealed-return | `1` | No | No | No
|===

TODO: this condition needs to be reflected in the load/store instructions.
