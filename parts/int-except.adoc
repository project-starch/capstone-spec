...
.*Note: Implementation specified exception code*
[%collapsible]
====
****
For some of the exception code, where the exception is raised is not
...
****
The figure below shows the overview of domain switch in _{isa_var_pure}_,
including synchronous link:#domain-cross[domain crossing] and asynchronous
interrupt/exception handling.

.Overview of domain switch in _{isa_var_pure}_
image::pure-domain.svg[pure-domain]
****
...
****
The figure below shows the overview of interrupt handling in _{isa_var_hybrid}_.

.Overview of interrupt handling in _{isa_var_hybrid}_
...
****
The figure below shows the overview of exception handling in _{isa_var_hybrid}_.

.Overview of exception handling in _{isa_var_hybrid}_
