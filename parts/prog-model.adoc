...
| _Normal Memory_ | `[0, SBASE) U [SEND, 2^XLEN)` | MMU
| _Secure Memory_ | `[SBASE, SEND)` | Capabilities
|===
...
! `emode` ! `0x011` ! The encoding mode of the system. `0` = integer encoding mode, `1` = capability encoding mode
