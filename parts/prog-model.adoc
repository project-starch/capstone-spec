...
| Sealed-return | `0` | `cursor in [base + 2 * CLENBYTES, base + 33 * CLENBYTES - size]` | `cursor in [base + 2 * CLENBYTES, base + 33 * CLENBYTES - size]` | No
| Exit | - | `cursor in [base + 2 * CLENBYTES, base + 33 * CLENBYTES - size]` | `cursor in [base + 2 * CLENBYTES, base + 33 * CLENBYTES - size]` | No
|===
...
====
****
`cwrld` is a special register added in _{isa_var_hybrid}_ that indicates the currently executed world.
