...
|`end` | `0..2^XLEN-1` | The end memory address of the memory region associated with the capability
...
TODO: describe the allowed behaviour of compression. In particular,
what should happen if an operation will result in loss of precision.
****
